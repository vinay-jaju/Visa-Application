...
public class ManagerCommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onResponse(String response) {
                try{
                    ...
                    if(success){
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(ManagerCommentsActivity.this);
        ...
        ManagerCommentRequest employeeStatusRequest = new ManagerCommentRequest(employee_code,responseListener);
        RequestQueue queue = Volley.newRequestQueue(ManagerCommentsActivity.this);
