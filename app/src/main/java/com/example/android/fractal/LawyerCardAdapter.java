 ...
 */
public class LawyerCardAdapter extends RecyclerView.Adapter<LawyerCardAdapter.ViewHolder> {

    private Context context;

    //List of superHeroes
    List<LawyerApplicationData> superHeroes;

    public LawyerCardAdapter(List<LawyerApplicationData> superHeroes, Context context){
        super();
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        LawyerApplicationData superHero =  superHeroes.get(position);
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            LawyerApplicationData application_details =  superHeroes.get(pos);
            ...
            Intent in = new Intent(v.getContext(), LawyerApplicationDecisionActivity.class);
