...
public class AdminCommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onResponse(String response) {
                try{
                    ...
                    if(success){
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(AdminCommentsActivity.this);
        ...
        AdminCommentRequest employeeStatusRequest = new AdminCommentRequest(employee_code,responseListener);
        RequestQueue queue = Volley.newRequestQueue(AdminCommentsActivity.this);
