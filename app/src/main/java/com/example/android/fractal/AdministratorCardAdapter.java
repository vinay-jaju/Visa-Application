 ...
 */
public class AdministratorCardAdapter extends RecyclerView.Adapter<AdministratorCardAdapter.ViewHolder> {

    //private ImageLoader imageLoader;
    private Context context;

    //List of superHeroes
    List<ApplicationData> superHeroes;

    public AdministratorCardAdapter(List<ApplicationData> superHeroes, Context context){
        super();
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        ApplicationData superHero =  superHeroes.get(position);
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            ApplicationData application_details =  superHeroes.get(pos);
            ...
            Intent in = new Intent(v.getContext(), AdminApplicationDecisionActivity.class);
